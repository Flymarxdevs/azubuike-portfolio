<template>
	...
	<button @click="toggleNav" :class="{active: navActive.active}" class="site-nav-btn md:hidden relative w-6 h-3.5 z-30"></button>
</template>
<style scoped>
...
.site-nav-btn.active::before, .site-nav-btn.active::after{
	@apply bg-indigo-50;
}
